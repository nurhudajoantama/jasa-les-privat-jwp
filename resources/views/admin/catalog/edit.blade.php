...
<div class="container mt-5 pt-4">
    ...
    <form action="{{ route('admin.catalog.update', $course) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            @if($course->image)
                <img src="{{ asset('storage/' . $course->image) }}" alt="" class="img-thumbnail mb-2" style="max-width:150px;">
            @endif
